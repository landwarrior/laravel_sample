                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="user_cd" class="col-md-4 col-form-label text-md-right">{{ __('messages.user_cd') }}</label>

                            <div class="col-md-6">
                                <input id="user_cd" type="text" class="form-control @error('user_cd') is-invalid @enderror" name="user_cd" value="{{ old('user_cd') }}" required autocomplete="user_cd" autofocus>
                        ...
                        <!-- <div class="form-group row">
                            <label for="is_admin" class="col-md-4 col-form-label text-md-right">{{ __('messages.is_admin') }}</label>
                            <div class="col-md-6">
                                <input id="is_admin" type="checkbox" class="form-control @error('is_admin') is-invalid @enderror" name="is_admin[]" value="{{ old('is_admin') }}" autocomplete="is_admin">
